                     ...
                     <div class="col-sm-12">
                            <div class="col-sm-6 col-sm-offset-3 form-box">
                                ...
                                <div class="form-top">
                                    ...
                                    $pdocrud->fieldAttributes("city", array("placeholder" => "City")); //add placeholder attribute
                                    $pdocrud->fieldAttributes("state", array("placeholder" => "State")); //add placeholder attribute
...
//                                    $pdocrud->fieldDataBinding("country", "country", "country_id", "country_name", "db"); //add data using another table name country
                                    ...
                                    $pdocrud->fieldHideLable("city"); // Hide label
                                    $pdocrud->fieldHideLable("state"); // Hide label
                                    $pdocrud->fieldHideLable("country"); // Hide label
                                    ...
                                    $pdocrud->enqueueCss("font-awesome.min", "http://localhost/formdoid/demo/moreforms/form3/assets/font-awesome/css/font-awesome.min.css");

                                    $pdocrud->enqueueCss("form-elements", "http://localhost/formdoid/demo/moreforms/form3/assets/css/form-elements.css");
                                    $pdocrud->enqueueCss("style", "http://localhost/formdoid/demo/moreforms/form3/assets/css/style.css");
