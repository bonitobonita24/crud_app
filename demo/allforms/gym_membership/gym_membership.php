...
<html>
    <head>
        ...
        <title>PDOCrud - Gym Membership form</title>

    </head>
    <body>
        <header>
            <div class="heading">
                <a href="#" class="PDOCrud-logo"> <h3> PDOCrud - Gym Membership form demo </h3></a>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-8 col-sm-offset-2 form-box">
                              <div class="form-top">
                                    <?php
                                    $pdocrud = new PDOCrud();
                                    $pdocrud->formStaticFields("personalinfo", "html", "<div class='form-top-left'><h3>PDOCrud Gym Membership Form</h3><p>Apply for the gym membership online.</p></div>");
                                    ...
                                    $pdocrud->formFields(array("personalinfo", "personalinfo1", "gender", "membership_person_wise", "member_type", "full_name", "email", "age", "designation", "phone","address"  ,"city", "state", "country"));
                                    ...
                                    $pdocrud->fieldGroups("booking", array("email", "phone"));
                                    $pdocrud->fieldGroups("booking1", array("gender", "age"));
                                    $pdocrud->fieldGroups("booking2", array("city", "state"));
                                    ...
                                    $pdocrud->fieldDataBinding("gender", array("Male", "Female"), "", "", "array"); //add data for radio button
                                      ...
                                      $pdocrud->fieldTypes("membership_person_wise", "checkbox"); //change donation amount to radio button
                                    $pdocrud->fieldDataBinding("membership_person_wise", array("Single membership", "Couple membership", "Friends Group"), "", "", "array"); //add data for radio button
                                    
                                   
                                    $pdocrud->fieldTypes("member_type", "radio"); //change donation amount to radio button
                                    $pdocrud->fieldDataBinding("member_type", array("Gym + Personal Training", "Gym + Sona Bath", "Gym + Yoga"), "", "", "array"); //add data for radio button
                                   ...
                                   // $pdocrud->enqueueCss("form-elements", "../assets/css/form-elements.css");
                                    ...
                                    echo $pdocrud->dbTable("gym_membership")->render("insertform");
                                    ?>
                                </div>
                            </div>
                        </div>
