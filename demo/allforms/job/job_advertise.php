...
<html>
    <head>
        ...
        <title>PDOCrud - Job advertise form</title>

    </head>
    <body>
        <header>
            <div class="heading">
                <a href="#" class="PDOCrud-logo"> <h3> PDOCrud - Job advertise form demo </h3></a>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-8 col-sm-offset-2 form-box">
                                <div class="form-top">
                                    <?php
                                    $pdocrud = new PDOCrud();
                                    $pdocrud->formStaticFields("personalinfo", "html", "<div class='form-top-left'><h3>PDOCrud Job advertise Form</h3><p>Please Fill in the form below</p></div>");
                                    ...
                                    $pdocrud->formFields(array("personalinfo", "personalinfo1", "job_title", "job_description", "salary_range", "expiration_date"));

                                  

                                    $pdocrud->fieldTypes("salary_range", "radio"); //change donation amount to radio button
                                    $pdocrud->fieldDataBinding("salary_range", array("0-500$", "500-1000$", "1000-20005$", "2000-3000$"), "", "", "array"); //add data for radio button
                                    $pdocrud->fieldTooltip("salary_range", "Please select a range of the job salary per month."); //tooltip
                                    $pdocrud->fieldTooltip("expiration_date", "When the Job Interviews will ended."); //tooltip
...
//$pdocrud->formFields(array("first_name","resume"));
                                    ...
                                    $pdocrud->fieldCssClass("email", array("form-first-name")); // add class 
                                        ...
                                        $pdocrud->enqueueCss("font-awesome.min", "../../assets/font-awesome/css/font-awesome.min.css");
                                    $pdocrud->enqueueCss("form-elements", "../../assets/css/form-elements.css");
                                    $pdocrud->enqueueCss("style", "../../assets/css/style.css");

                                    echo $pdocrud->dbTable("job")->render("insertform");
                                    ?>
                                </div>
                            </div>
                        </div>
