...
<html>
    <head>
        ...
        <title>PDOCrud - Feedback form</title>

    </head>
    <body>
        <header>
            <div class="heading">
                <a href="#" class="PDOCrud-logo"> <h3> PDOCrud - Customer Feedback form demo </h3></a>
            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-6 col-sm-offset-3 form-box">
                                <div class="form-top">
                                    <?php
                                    $pdocrud = new PDOCrud();
                                    $pdocrud->formStaticFields("personalinfo", "html", "<div class='form-top-left'><h3>PDOCrud Feedback Form</h3><p>Please Fill in the form below</p></div>");
                                    ...
                                    $pdocrud->formFields(array("personalinfo", "personalinfo1", "first_name", "last_name", "email", "phone", "service_satisfaction", "comments"));
                                    ...
                                    $pdocrud->fieldTypes("service_satisfaction", "radio"); //change donation amount to radio button
                                    $pdocrud->fieldDataBinding("service_satisfaction", array("Excellent", "Very Good", "Good", "Average", "Poor"), "", "", "array"); //add data for radio button
//                                
...
//                                    $pdocrud->fieldDataBinding("country", "country", "country_id", "country_name", "db"); //add data using another table name country
                           ...
                           $pdocrud->enqueueCss("font-awesome.min", "../assets/css/font-awesome/css/font-awesome.min.css");
                                    ...
                                    echo $pdocrud->dbTable("feedback")->render("insertform");
                                    ?>
                                </div>
                            </div>
                        </div>
