    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    Multi table relation in tabs (nested tables) of view
                    <small>Editing of related records in other table (Added in v 2.6)</small>
                </h1>
                <p> PDOCrud allows the editing of related records of different table i.e. similar to nested table.  
                    ...
                    You can define relation between the two tables data using some binding column value.<b>Please note that
                    main tables must have fields present that are used for where condition to bind records. You need to enable
                    $config["viewFormTabs"] = true; to make this work</b>
                </p>
            </section>    
            <!-- Default box -->
            <div class="box">                
