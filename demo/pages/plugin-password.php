            ...
            <section class="content">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Plugin file input example - PDOCrud</h3>
                    ...
                    <div class="box-body">
                        <div class="box-body table-responsive no-padding">
                            <?php
                            $pdocrud = new PDOCrud();
                            $pdocrud->addPlugin("password");//to add plugin          
                            $pdocrud->formFields(array("username","password"));
                            echo $pdocrud->dbTable("users")->render("insertform");
                            echo $pdocrud->loadPluginJsCode("password","input[type=password]");//to add plugin call on input[type=file] elements
                            ?>
                        </div><!-- /.box-body -->
                    </div>
                </div>
